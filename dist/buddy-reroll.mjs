...
var PREF_PATH = join(homedir(), ".claude-buddy.json");
var MIN_CC_VER = "2.1.89";
var SPECIES = ["duck", "goose", "blob", "cat", "dragon", "octopus", "owl", "penguin", "turtle", "snail", "ghost", "axolotl", "capybara", "cactus", "robot", "rabbit", "mushroom", "chonk"];
var RARITIES = ["common", "uncommon", "rare", "epic", "legendary"];
var RARITY_W = { common: 60, uncommon: 25, rare: 10, epic: 4, legendary: 1 };
...
var SPRITE_PRESETS = {
  neko: { name: { en: "\u{1F431} Catgirl", zh: "\u{1F431} \u732B\u8033\u5A18" }, face: "({E}\u03C9{E})", sprite: [
    ["            ", "  /\\    /\\  ", " ( {E}  w  {E} )", "  |  \u2661  |  ", "  (______)  "],
    ["            ", "  /\\    /\\  ", " ( {E}  w  {E} )", "  |     |  ", "  (______)~ "],
    ["  \u2661    \u2661   ", "  /\\    /\\  ", " ( {E}  w  {E} )", "  |  \u2661  |  ", "  (______)  "]
  ] },
  fox: { name: { en: "\u{1F98A} Fox", zh: "\u{1F98A} \u72D0\u72F8" }, face: "({E}\u03C9{E})", sprite: [
    ["            ", "   /\\_/\\    ", "  ( {E} \u03C9 {E})  ", "  /|    |\\  ", " (_|    |_) "],
    ["            ", "   /\\_/\\    ", "  ( {E} \u03C9 {E})  ", "  /|    |\\  ", " (_|    |_)~"],
    ["    ~ ~     ", "   /\\_/\\    ", "  ( {E} \u03C9 {E})  ", "  /|    |\\  ", " (_|    |_) "]
  ] },
  bunny: { name: { en: "\u{1F430} Bunny", zh: "\u{1F430} \u5154\u8033\u5A18" }, face: "({E}\xB7{E})", sprite: [
    ["    ||  ||  ", "    ||  ||  ", " ( {E}  \xB7 {E} ) ", "   \\    /   ", "    (==)    "],
    ["    ||  ||  ", "    |\\  /|  ", " ( {E}  \xB7 {E} ) ", "   \\    /   ", "    (==)  ~ "],
    ["   \u2661 \u2661\u2661 \u2661  ", "    ||  ||  ", " ( {E}  \xB7 {E} ) ", "   \\    /   ", "    (==)    "]
  ] },
  ...
  bear: { name: { en: "\u{1F43B} Bear", zh: "\u{1F43B} \u5C0F\u718A" }, face: "({E}\u1D25{E})", sprite: [
    ["            ", "  (\\  /)   ", " ( {E} \u1D25 {E} )  ", "  />  <\\   ", " (__\\/__) "],
    ["            ", "  (\\  /)   ", " ( {E} \u1D25 {E} )  ", "  />  <\\   ", " (__\\/__) ~"],
    ["    z Z     ", "  (\\  /)   ", " ( -  \u1D25  - )  ", "  />  <\\   ", " (__\\/__) "]
  ] },
  devil: { name: { en: "\u{1F608} Devil", zh: "\u{1F608} \u5C0F\u6076\u9B54" }, face: "{E}v{E}", sprite: [
    ["   )    (   ", "  /\\    /\\  ", " ( {E}  v  {E} )", "   \\~~~~/ ^ ", "    \\  /    "],
    ["   )    (   ", "  /\\    /\\  ", " ( {E}  v  {E} )", "   \\~~~~/ ^ ", "    \\  / ~  "],
    ["   ) ** (   ", "  /\\    /\\  ", " ( {E}  v  {E} )", "   \\~~~~/ ^ ", "    \\  /    "]
  ] },
  alien: { name: { en: "\u{1F47D} Alien", zh: "\u{1F47D} \u5916\u661F\u4EBA" }, face: "{E}_{E}", sprite: [
    ["            ", '   .-""-.   ', "  / {E}  {E} \\  ", "  |  __  |  ", "   \\____/   "],
    ["            ", '   .-""-.   ', "  / {E}  {E} \\  ", "  |  __  |  ", "   \\____/ ~ "],
    ["   *  . *   ", '   .-""-.   ', "  / {E}  {E} \\  ", "  |  __  |  ", "   \\____/   "]
  ] },
  slime: { name: { en: "\u{1F7E2} Slime", zh: "\u{1F7E2} \u53F2\u83B1\u59C6" }, face: "({E}~{E})", sprite: [
    ["            ", "    ____    ", "  / {E}  {E} \\  ", "  | ~~~~ |  ", "  (______)  "],
    ["            ", "    ____    ", "  / {E}  {E} \\  ", "  | ~~~~ |  ", " (__________) "],
    ["    ~ ~     ", "    ____    ", "  / {E}  {E} \\  ", "  | ~~~~ |  ", "  (______)  "]
  ] },
  kirby: { name: { en: "\u{1FA77} Kirby", zh: "\u{1FA77} \u5361\u6BD4" }, face: "({E}\u25BD{E})", sprite: [
    ["            ", "   .----.   ", "  ( {E} \u25BD {E} )  ", "  /|    |\\  ", "   o    o   "],
    ["            ", "   .----.   ", "  ( {E} \u25BD {E} )~ ", "  /|    |\\  ", "   o    o   "],
    ["    \u2606  \u2606   ", "   .----.   ", "  ( {E} \u25BD {E} )  ", "  /|    |\\  ", "   o    o   "]
  ] },
  totoro: { name: { en: "\u{1F333} Totoro", zh: "\u{1F333} \u9F99\u732B" }, face: "({E}\u25B3{E})", sprite: [
    ["            ", "   /~~~~\\   ", "  ( {E} \u25B3 {E} )  ", "  |VVVVVV|  ", "  (__)(__)  "],
    ["            ", "   /~~~~\\   ", "  ( {E} \u25B3 {E} )  ", "  |VVVVVV|  ", "  (__)(__)~ "],
    ["    \u{1F302}      ", "   /~~~~\\   ", "  ( {E} \u25B3 {E} )  ", "  |VVVVVV|  ", "  (__)(__)  "]
  ] },
  cthulhu: { name: { en: "\u{1F991} Cthulhu", zh: "\u{1F991} \u514B\u82CF\u9C81" }, face: "{E}}{E}", sprite: [
    ["            ", "   /\\  /\\   ", "  ( {E} }{ {E} ) ", "   |/\\/\\|   ", "  ~~~~~~~~  "],
    ["            ", "   /\\  /\\   ", "  ( {E} }{ {E} ) ", "   |\\/\\/|   ", "  ~~~~~~~~~ "],
    ["   * .  *   ", "   /\\  /\\   ", "  ( {E} }{ {E} ) ", "   |/\\/\\|   ", "  ~~~~~~~~  "]
  ] },
  miku: { name: { en: "\u{1F3A4} Miku", zh: "\u{1F3A4} \u521D\u97F3" }, face: "({E}\u2200{E})", sprite: [
    ["    \u266A   \u266A   ", " ]==   ==[ ", " ( {E}  \u2200  {E} )", "   \\    /   ", "    |  |    "],
    ["     \u266A  \u266A   ", " ]==   ==[ ", " ( {E}  \u2200  {E} )", "   \\    /   ", "    |  |  ~ "],
    ["   \u266A \u266B \u266A   ", " ]==   ==[ ", " ( {E}  \u2200  {E} )", "   \\    /   ", "    |  |    "]
  ] },
  panda: { name: { en: "\u{1F43C} Panda", zh: "\u{1F43C} \u718A\u732B" }, face: "({E}_{E})", sprite: [
    ["            ", "  \u25CB\\  /\u25CB   ", "  ( {E}  _ {E} ) ", "   \\    /   ", "   (====)   "],
    ["            ", "  \u25CB\\  /\u25CB   ", "  ( {E}  _ {E} ) ", "   \\    /   ", "   (====) ~ "],
    ["    \u{1F38B}      ", "  \u25CB\\  /\u25CB   ", "  ( {E}  _ {E} ) ", "   \\    /   ", "   (====)   "]
  ] },
  bat: { name: { en: "\u{1F987} Bat", zh: "\u{1F987} \u8759\u8760" }, face: "{E}w{E}", sprite: [
    ["  /|    |\\  ", " / |    | \\ ", "   ({E} w {E})  ", "    \\  /    ", "     \\/     "],
    ["  /|    |\\  ", " / |    | \\ ", "   ({E} w {E})  ", "    \\  /    ", "     \\/   ~ "],
    [" ~/|    |\\~ ", " / |    | \\ ", "   ({E} w {E})  ", "    \\  /    ", "     \\/     "]
  ] },
  cxk: { name: { en: "\u{1F3C0} CXK", zh: "\u{1F3C0} \u5764\u54E5" }, face: "({E} _ {E})", sprite: [
    ["            ", "  ({E} _ {E})   ", "  \\|--|/    ", " / o    \\   ", "d        b  "],
    ["            ", " \\({E} _ {E})/  ", "   |--|     ", "   |  |     ", "  d  b   o  "],
    ["  \u266A    \u266B    ", "   ({E} _ {E})  ", "  \\|--|/    ", " /   o   \\  ", "d         b "]
  ] }
...
var SP_E = { duck: "\u{1F986}", goose: "\u{1FABF}", blob: "\u{1FAE7}", cat: "\u{1F431}", dragon: "\u{1F409}", octopus: "\u{1F419}", owl: "\u{1F989}", penguin: "\u{1F427}", turtle: "\u{1F422}", snail: "\u{1F40C}", ghost: "\u{1F47B}", axolotl: "\u{1F98E}", capybara: "\u{1F9AB}", cactus: "\u{1F335}", robot: "\u{1F916}", rabbit: "\u{1F430}", mushroom: "\u{1F344}", chonk: "\u{1F408}" };
var HAT_E = { none: "\u2014", crown: "\u{1F451}", tophat: "\u{1F3A9}", propeller: "\u{1F9E2}", halo: "\u{1F607}", wizard: "\u{1F9D9}", beanie: "\u26D1", tinyduck: "\u{1F424}" };
var RAR_S = { common: "\u2605", uncommon: "\u2605\u2605", rare: "\u2605\u2605\u2605", epic: "\u2605\u2605\u2605\u2605", legendary: "\u2605\u2605\u2605\u2605\u2605" };
var NO_CLR = !!process.env.NO_COLOR || process.argv.includes("--no-color");
var TTY = process.stdout.isTTY !== false;
var E = { rs: "\x1B[0m", b: "\x1B[1m", d: "\x1B[2m", r: "\x1B[31m", g: "\x1B[32m", y: "\x1B[33m", bl: "\x1B[34m", m: "\x1B[35m", c: "\x1B[36m", w: "\x1B[37m", gr: "\x1B[90m" };
var RC = { common: E.w, uncommon: E.g, rare: E.bl, epic: E.m, legendary: E.y };
var c = (code, text) => !NO_CLR && TTY ? `${code}${text}${E.rs}` : text;
var L = "en";
var I = {
  banner: { en: "\u{1F3B0} Claude Buddy Reroller", zh: "\u{1F3B0} Claude Buddy \u5BA0\u7269\u91CD\u94F8\u5668" },
  ...
  menu_search: { en: "\u{1F50D}  Search & apply buddy", zh: "\u{1F50D}  \u641C\u7D22\u5E76\u5E94\u7528\u5BA0\u7269" },
  menu_check: { en: "\u{1F440}  Check current buddy", zh: "\u{1F440}  \u67E5\u770B\u5F53\u524D\u5BA0\u7269" },
  menu_diy: { en: "\u270F\uFE0F   Customize buddy", zh: "\u270F\uFE0F   \u81EA\u5B9A\u4E49\u5BA0\u7269" },
  menu_gallery: { en: "\u{1F4CB}  Species gallery", zh: "\u{1F4CB}  \u7269\u79CD\u56FE\u9274" },
  menu_test: { en: "\u{1F9EA}  Self-test hash", zh: "\u{1F9EA}  \u81EA\u68C0 Hash" },
  menu_lang: { en: "\u{1F310}  Switch language", zh: "\u{1F310}  \u5207\u6362\u8BED\u8A00" },
  menu_exit: { en: "\u{1F44B}  Exit", zh: "\u{1F44B}  \u9000\u51FA" },
  ...
  chk_oauth: { en: "\u{1F50D} Current Buddy (OAuth):", zh: "\u{1F50D} \u5F53\u524D\u5BA0\u7269 (OAuth):" },
  chk_oauth_w: { en: "\u26A0 OAuth active \u2014 this is what /buddy shows.", zh: "\u26A0 OAuth \u5DF2\u767B\u5F55 \u2014 \u8FD9\u662F /buddy \u663E\u793A\u7684\u5BA0\u7269\u3002" },
  chk_after: { en: "\u{1F504} After apply (userID):", zh: "\u{1F504} apply \u540E (userID):" },
  chk_cur: { en: "\u{1F50D} Current Buddy (userID):", zh: "\u{1F50D} \u5F53\u524D\u5BA0\u7269 (userID):" },
  chk_none: { en: "No config found.", zh: "\u672A\u627E\u5230\u914D\u7F6E\u3002" },
  chk_no_id: { en: "No userID or OAuth found.", zh: "\u672A\u627E\u5230 userID \u6216 OAuth\u3002" },
  gal_sp: { en: "\u{1F4CB} All 18 Species:", zh: "\u{1F4CB} \u5168\u90E8 18 \u4E2A\u7269\u79CD:" },
  gal_rar: { en: "\u{1F3B2} Rarities:", zh: "\u{1F3B2} \u7A00\u6709\u5EA6:" },
  gal_eye: { en: "\u{1F440} Eyes:", zh: "\u{1F440} \u773C\u775B:" },
  gal_hat: { en: "\u{1F3A9} Hats:", zh: "\u{1F3A9} \u5E3D\u5B50:" },
  gal_note: { en: "Shiny: 1%. Common pets have no hats.", zh: "\u95EA\u5149: 1%\u3002\u666E\u901A\u54C1\u8D28\u6CA1\u6709\u5E3D\u5B50\u3002" },
  s_target: { en: "\u{1F3AF} Searching:", zh: "\u{1F3AF} \u641C\u7D22:" },
  ...
  t_title: { en: "\u{1F9EA} Self-Test: Hash", zh: "\u{1F9EA} \u81EA\u68C0: Hash" },
  ...
  tip_override: { en: '\u{1F4A1} Tip: edit ~/.claude.json \u2192 "companionOverride" to fine-tune species/rarity/eye/hat/shiny/stats/customFace/customSprite anytime.', zh: '\u{1F4A1} \u63D0\u793A: \u7F16\u8F91 ~/.claude.json \u2192 "companionOverride" \u53EF\u968F\u65F6\u5FAE\u8C03\u7269\u79CD/\u7A00\u6709\u5EA6/\u773C\u775B/\u5E3D\u5B50/\u95EA\u5149/\u5C5E\u6027/\u81EA\u5B9A\u4E49\u8868\u60C5/\u7CBE\u7075\u56FE\u3002' }
};
function t(k, ...a) {
  const m = I[k]?.[L] || I[k]?.["en"] || k;
  return a.length ? m.replace(/\{(\d+)\}/g, (_, i) => a[+i] ?? "") : m;
}
var ask = (q) => new Promise((r) => {
...
function saveLang(l) {
  writeFileSync(PREF_PATH, JSON.stringify({ lang: l }, null, 2), "utf8");
}
async function pickLang() {
  console.log("");
  console.log(c(E.b + E.c, "  \u{1F3B0} Claude Buddy Reroller") + c(E.d, ` v${VERSION}`));
  console.log(`
  ${c(E.b, "\u{1F310} Select language / \u9009\u62E9\u8BED\u8A00:")}
`);
  console.log(`    ${c(E.c, "[1]")} English`);
  console.log(`    ${c(E.c, "[2]")} \u4E2D\u6587`);
  const a = await ask(`
  ${c(E.c, ">")} `);
  const l = a.trim() === "2" ? "zh" : "en";
  saveLang(l);
  console.log(c(E.g, `
  ${l === "zh" ? I.lang_saved.zh : I.lang_saved.en}`));
  return l;
}
var M64 = (1n << 64n) - 1n;
var WYP = [0xa0761d6478bd642fn, 0xe7037ed1a0b428dbn, 0x8ebc6af09c88c6e3n, 0x589965cc75374cc3n];
function _mx(A, B) {
  const r = (A & M64) * (B & M64);
  return (r >> 64n ^ r) & M64;
}
...
function hWy(s) {
  return IS_BUN ? Number(BigInt(Bun.hash(s)) & 0xffffffffn) : Number(wyhash(Buffer.from(s, "utf8")) & 0xffffffffn);
}
function hFnv(s) {
  let h = 2166136261;
...
var HASH_MODE = "wyhash";
var IS_WIN = process.platform === "win32";
function whichBin(name) {
  try {
    const cmd = IS_WIN ? `where ${name}` : `which ${name}`;
    return execSync(cmd, { timeout: 3e3, encoding: "utf8" }).trim().split(/\r?\n/)[0];
  } catch {
    return null;
  }
}
function detectHash() {
  ...
  if (i !== -1) {
    const v = (process.argv[i + 1] || "").toLowerCase();
    return v === "fnv" || v === "fnv1a" ? "fnv1a" : "wyhash";
  }
  try {
    const d = JSON.parse(readFileSync(PREF_PATH, "utf8"));
    if (d.hashMode) return d.hashMode;
  } catch {
  }
  try {
    const w = whichBin("claude");
    if (w) {
      const r = realpathSync(w);
      if (r.includes("node_modules") || r.endsWith(".js")) return "fnv1a";
    }
  } catch {
  }
  if (findCliJs()) return "fnv1a";
  return "wyhash";
}
function hash(s) {
  return HASH_MODE === "fnv1a" ? hFnv(s) : hWy(s);
}
function prng(seed) {
  let a = seed >>> 0;
  return () => {
...
function rollStats(rng, rar) {
  const fl = RARITY_FLOOR[rar], pk = pick(rng, STATS);
...
function roll(uid, salt = SALT, hashFn = hash) {
  const rng = prng(hashFn(uid + salt)), rar = rollRar(rng);
  return { rarity: rar, species: pick(rng, SPECIES), eye: pick(rng, EYES), hat: rar === "common" ? "none" : pick(rng, HATS), shiny: rng() < 0.01, stats: rollStats(rng, rar) };
}
function bar(v, w = 20) {
  const f = Math.round(v / 100 * w);
  return `${c(v >= 80 ? E.g : v >= 50 ? E.y : v >= 30 ? E.w : E.r, "\u2588".repeat(f) + "\u2591".repeat(w - f))} ${v}`;
}
function fmt(b, uid, verbose = true) {
  const ln = [""], rC = RC[b.rarity];
  ln.push(c(rC + E.b, `  ${SP_E[b.species] || "?"} ${b.species.toUpperCase()}`));
  ln.push(c(rC, `  ${RAR_S[b.rarity]} ${b.rarity}`) + (b.shiny ? c(E.y + E.b, " \u2728 SHINY!") : ""));
  ln.push(c(E.gr, `  Eyes: ${b.eye}  |  Hat: ${HAT_E[b.hat]} ${b.hat}`));
  if (verbose) {
    ln.push("");
    for (const [n, v] of Object.entries(b.stats)) ln.push(`  ${n.padEnd(10)} ${bar(v)}`);
  }
  if (uid) {
    ln.push("");
    ln.push(c(E.d, `  UserID: ${uid}`));
  }
  ln.push("");
  return ln.join("\n");
}
function banner() {
  console.log("");
  console.log(c(E.b + E.c, `  ${t("banner")}`) + c(E.d, ` v${VERSION}`));
  const h = HASH_MODE === "fnv1a" ? "FNV-1a (npm)" : "wyhash (native)";
  console.log(c(E.d, `  ${IS_BUN ? t("rt_bun") : t("rt_node")} | Hash: ${h}`));
  console.log("");
}
function readCfg() {
...
function getCCVer() {
  try {
    for (const p of [join(homedir(), ".local", "bin", "claude"), "/usr/local/bin/claude"]) {
      ...
      try {
        const m = realpathSync(p).match(/(\d+\.\d+\.\d+)/);
        if (m) return m[1];
      } catch {
      }
    }
    const d = join(homedir(), ".local", "share", "claude", "versions");
    if (existsSync(d)) {
      const v = readdirSync(d).filter((f) => /^\d+\.\d+\.\d+$/.test(f)).sort(cmpVer);
      if (v.length) return v[v.length - 1];
    }
  } catch {
  }
  try {
    const m = execSync("claude --version", { timeout: 5e3, encoding: "utf8" }).match(/(\d+\.\d+\.\d+)/);
    if (m) return m[1];
  } catch {
  }
  return null;
...
function chkVer() {
  const v = getCCVer();
  if (!v) {
    console.log(c(E.y, `  ${t("v_unk", MIN_CC_VER)}`));
    return "unknown";
  }
  if (cmpVer(v, MIN_CC_VER) < 0) {
    console.log(c(E.r + E.b, `  ${t("v_old", v, MIN_CC_VER)}`));
    return "outdated";
  }
  console.log(c(E.d, `  ${t("v_ok", v)}`));
  return "ok";
}
...
function criteriaLabel(cr) {
  const p = [];
  if (cr.shiny) p.push("\u2728");
  if (cr.rarity) p.push(cr.rarity);
  if (cr.species) p.push(`${SP_E[cr.species]} ${cr.species}`);
  if (cr.eye) p.push(`eye:${cr.eye}`);
  if (cr.hat) p.push(`hat:${cr.hat}`);
  return p.join(" ");
}
function match(b, cr) {
  if (cr.species && b.species !== cr.species) return false;
  if (cr.rarity && b.rarity !== cr.rarity) return false;
  if (cr.eye && b.eye !== cr.eye) return false;
  if (cr.hat && b.hat !== cr.hat) return false;
  if (cr.shiny != null && b.shiny !== cr.shiny) return false;
  return true;
}
function search(cr, limit = 5e6, saltOverride = null) {
  const results = [], start = Date.now();
  let best = null;
  const hashFn = saltOverride ? hWy : hash;
  ...
  for (let i = 0; i < limit; i++) {
    ...
    if (i > 0 && i % 5e5 === 0 && TTY) console.log(c(E.d, `  ... ${i.toLocaleString()} (${((Date.now() - start) / 1e3).toFixed(1)}s) ...`));
  }
  console.log(c(E.d, `
  ${t("s_done", limit.toLocaleString(), ((Date.now() - start) / 1e3).toFixed(2))}`));
  return results;
}
function findCliJs() {
  const cands = [];
  try {
    const o = execSync("npm root -g", { timeout: 5e3, encoding: "utf8" }).trim();
    if (o && !o.includes("Unknown")) cands.push(join(o, "@anthropic-ai", "claude-code", "cli.js"));
  } catch {
  }
  cands.push(join(homedir(), ".npm-global", "lib", "node_modules", "@anthropic-ai", "claude-code", "cli.js"), join("/usr", "local", "lib", "node_modules", "@anthropic-ai", "claude-code", "cli.js"), join(process.env.APPDATA || "", "npm", "node_modules", "@anthropic-ai", "claude-code", "cli.js"));
  for (const p of cands) if (existsSync(p)) return p;
  return null;
}
function findNative() {
  const home = homedir(), cands = [join(home, ".local", "bin", "claude"), join(home, ".claude", "local", "claude"), "/usr/local/bin/claude"];
  const la = process.env.LOCALAPPDATA || "";
  if (la) cands.push(join(la, "Programs", "ClaudeCode", "claude.exe"));
  for (const p of cands) {
    if (!existsSync(p)) continue;
    try {
      const r = realpathSync(p);
      if (r.endsWith(".js") || r.includes("node_modules")) continue;
      return r;
    } catch {
    }
  }
  ...
  if (existsSync(vd)) {
    const vs = readdirSync(vd).filter((f) => /^\d+\.\d+\.\d+$/.test(f)).sort(cmpVer);
    if (vs.length) return join(vd, vs[vs.length - 1]);
  }
  return null;
}
function detectInstall() {
  const cli = findCliJs(), bin = findNative();
  if (cli) {
    try {
      const w = whichBin("claude");
      if (w) {
        const r = realpathSync(w);
        if (r.includes("node_modules") || r.endsWith(".js")) return { mode: "npm", cli, bin };
      }
    } catch {
    }
    return { mode: bin ? "native" : "npm", cli, bin };
  }
  return { mode: bin ? "native" : null, cli, bin };
}
function detectEnvMisconfig() {
  const evs = { ...process.env };
  for (const sp of [join(homedir(), ".claude", "settings.json"), join(process.cwd(), ".claude", "settings.json")]) {
    try {
      const s = JSON.parse(readFileSync(sp, "utf8"));
      if (s.env) Object.assign(evs, s.env);
    } catch {
    }
  }
  const hasUrl = !!evs.ANTHROPIC_BASE_URL;
  const cloud = [evs.CLAUDE_CODE_USE_BEDROCK === "1" && "BEDROCK", evs.CLAUDE_CODE_USE_VERTEX === "1" && "VERTEX", evs.CLAUDE_CODE_USE_FOUNDRY === "1" && "FOUNDRY"].filter(Boolean);
  if (hasUrl && cloud.length) return t("env_warn", cloud.join(", "));
  return null;
}
function walkAst(node, cb) {
  if (!node || typeof node !== "object") return;
  cb(node);
  for (const k in node) if (node[k] && typeof node[k] === "object") {
    if (Array.isArray(node[k])) node[k].forEach((ch) => walkAst(ch, cb));
    else walkAst(node[k], cb);
  }
}
function npmPatchAll(cliPath) {
  const bak = cliPath + ".original";
  if (!existsSync(bak)) copyFileSync(cliPath, bak);
  ...
  if (code.includes(MARKER)) {
    console.log(c(E.g, `  \u2713 ${t("p_ast_v3")}`));
    return;
  }
  code = code.replace(/\n;globalThis\.__buddyConfig=\{[^;]+\};\/\*__ccbuddy(?:_v2)?__(?::ctrl)?\*\/\n/g, "");
  let ast;
  try {
    ast = parse3(code, { ecmaVersion: 2022, sourceType: "module" });
  } catch (e) {
    console.log(c(E.r, `  ${t("p_ast_fail")}: ${e.message}`));
    return;
  }
  ...
  walkAst(ast, (n) => {
    ...
    if (!T.buddyLive && n.params.length === 0 && etFnName && s.includes('"firstParty"') && s.includes("getMonth") && s.includes(etFnName + "()")) {
      ...
      T.buddyLive = n;
      V.buddyLive = { fnName: name, stmtsToRemove: stmts };
    }
    if (!T.buddyReact && n.async && s.includes("buddy_react")) {
      const stmts = [];
      for (let _si = 0; _si < body.body.length; _si++) {
        const st = body.body[_si];
        if (st.type !== "IfStatement") continue;
        const test = st.test;
        if (test.type === "BinaryExpression" && test.operator === "!==" && (test.right.type === "Literal" && test.right.value === "firstParty" || test.left.type === "Literal" && test.left.value === "firstParty")) stmts.push({ stmt: st, type: "firstParty" });
        ...
        if (test.type === "UnaryExpression" && test.operator === "!" && st.consequent?.type === "ReturnStatement" && st.consequent.argument?.value === null) {
          const prev = body.body[_si - 1];
          if (prev?.type === "VariableDeclaration" && src(prev).includes("organizationUuid"))
    ...
    if (!T.getCompanion && n.params.length === 0 && body.body?.length === 4) {
      ...
      T.getCompanion = n;
      V.getCompanion = { fnName: name, configVar: d1.id.name, configCall: src(d1.init.object), bonesVar: bp.value.name, rollCall: src(d3.init) };
    }
    if (!T.renderSprite && n.params.length === 2) {
      ...
      const fs0 = body.body[0];
      if (!fs0 || fs0.type !== "VariableDeclaration" || fs0.declarations.length !== 2) return;
      T.renderSprite = n;
      V.renderSprite = { fnName: name, bonesParam: n.params[0].name, frameParam: p1.left.name, framesVar: fs0.declarations[0].id.name, linesVar: fs0.declarations[1].id.name, bodiesVar: src(fs0.declarations[0].init.object), stmt0Node: fs0, decl1InitSrc: src(fs0.declarations[1].init) };
    }
    if (!T.spriteFrameCount && n.params.length === 1 && body.body?.length === 1 && n.end - n.start < 80) {
      ...
      V.spriteFrameCount = { fnName: name, speciesParam: n.params[0].name, bodiesVar: src(arg.object.object) };
    }
    if (!T.renderFace && n.params.length === 1 && body.body?.length === 2) {
      const [st1, st2] = body.body;
      if (st1?.type !== "VariableDeclaration") return;
      if (st1.declarations[0]?.init?.property?.name !== "eye") return;
      if (st2?.type !== "SwitchStatement") return;
      if (st2.discriminant?.property?.name !== "species") return;
      T.renderFace = n;
      V.renderFace = { fnName: name, bonesParam: n.params[0].name, eyeVar: st1.declarations[0].id.name };
    }
  });
  ...
  if (!found.length) {
    console.log(c(E.r, `  \u2717 ${L === "zh" ? "\u672A\u627E\u5230\u4EFB\u4F55\u76EE\u6807\u51FD\u6570" : "No target functions found"}`));
    return;
  }
  for (const m of missing) console.log(c(E.y, `  \u26A0 ${m}() ${L === "zh" ? "\u672A\u627E\u5230" : "not found"}`));
  if (!T.getCompanion) {
    console.log(c(E.r, `  \u2717 getCompanion() ${L === "zh" ? "\u5FC5\u987B\u627E\u5230\u624D\u80FD\u8865\u4E01" : "required \u2014 cannot patch"}`));
    return;
  }
  ...
  if (T.buddyReact) {
    ...
    for (const { stmt, type, testSrc } of V.buddyReact.stmtsToRemove) {
      ...
      if (type === "firstParty" && bh.apiTypeFn && _proxy)
        reps.push({ start: stmt.start, end: stmt.end, name: "buddyReact.thirdPartyProxy", replacement: `if(${bh.apiTypeFn}()!=="firstParty"){/*${MARKER}:thirdPartyReact*/${_proxy}}` });
      if (type === "noOrg" && _proxy)
        reps.push({ start: stmt.start, end: stmt.end, name: "buddyReact.noOrgProxy", replacement: `if(${testSrc}){/*${MARKER}:noOrgReact*/${_proxy}}` });
    }
  }
  if (T.getCompanion) {
  ...
  if (T.renderSprite) {
    ...
    reps.push({ start: v.stmt0Node.start, end: v.stmt0Node.end, name: "renderSprite", replacement: `var _csp=${cfgCall}.companionOverride;let ${v.framesVar}=(_csp&&Array.isArray(_csp.customSprite)&&_csp.customSprite.length>0)?_csp.customSprite:${v.bodiesVar}[${v.bonesParam}.species],${v.linesVar}=${v.decl1InitSrc};` });
  }
  if (T.spriteFrameCount) {
    const v = V.spriteFrameCount;
    reps.push({ start: T.spriteFrameCount.start, end: T.spriteFrameCount.end, name: "spriteFrameCount", replacement: `function ${v.fnName}(${v.speciesParam}){var _csp3=${cfgCall}.companionOverride;if(_csp3&&Array.isArray(_csp3.customSprite)&&_csp3.customSprite.length>0)return _csp3.customSprite.length;return ${v.bodiesVar}[${v.speciesParam}].length}` });
  }
  if (T.renderFace) {
    const v = V.renderFace;
    const bs = T.renderFace.body.start + 1;
    reps.push({ start: bs, end: bs, name: "renderFace", replacement: `var _cf4=${cfgCall}.companionOverride;if(_cf4&&typeof _cf4.customFace==="string")return _cf4.customFace.replaceAll("{E}",${v.bonesParam}.eye);` });
  }
...
` });
  ...
  let newCode = code;
  for (const r of reps) newCode = newCode.slice(0, r.start) + r.replacement + newCode.slice(r.end);
  if (newCode === code) {
    console.log(c(E.y, "  \u26A0 No changes made"));
    return;
  }
  try {
    parse3(newCode, { ecmaVersion: 2022, sourceType: "module" });
  } catch (e) {
    console.log(c(E.r, `  \u2717 AST verify failed: ${e.message}`));
    return;
  }
...
async function npmCheckPatches(cliPath) {
  ...
  if (code.includes(MARKER)) {
    console.log(c(E.g, `  ${t("p_chk_v3")}`));
    return;
  }
  if (code.includes("__ccbuddy_v2__") || code.includes("__ccbuddy__") || code.includes("_ccbov")) {
    console.log(c(E.y, `  ${t("p_chk_old")}`));
    return;
  }
  console.log(c(E.y, `  ${t("p_chk_none")}`));
}
var P_SPREAD_B = /if\(!(\w)\)return;let\{bones:(\w)\}=\w+\(\w+\(\)\);return\{\.\.\.\1,\.\.\.\2\}/;
var P_SPREAD_A = /if\(!(\w)\)return;let\{bones:(\w)\}=\w+\(\w+\(\)\);return\{\.\.\.\2,\.\.\.\1\}/;
var N_BUDDY_RE = /function (\w+)\(\)\{if\(\w+\(\)!=="firstParty"\)return!1;if\(\w+\(\)\)return!1;let (\w)=new Date;return \2\.getFullYear\(\)>2026\|\|\2\.getFullYear\(\)===2026&&\2\.getMonth\(\)>=3\}/;
function detectSalt(fp) {
  const buf = readFileSync(fp), pats = [/friend-\d{4}-\d+/, /ccbf-\d{10}/];
  const chunk = 10 * 1024 * 1024;
  for (let o = 0; o < buf.length; o += chunk - 50) {
    const s = buf.slice(o, Math.min(o + chunk, buf.length)).toString("ascii");
    for (const p of pats) {
      const m = s.match(p);
      if (m) return { salt: m[0], len: m[0].length };
    }
  }
  return null;
}
function genSalt() {
  return `ccbf-${Math.floor(Date.now() / 1e3).toString().padStart(10, "0")}`;
}
function bufReplace(buf, oldStr, newStr) {
  const oB = Buffer.from(oldStr), nB = Buffer.from(newStr);
  let p = 0;
  while (true) {
    const idx = buf.indexOf(oB, p);
    if (idx === -1) break;
    nB.copy(buf, idx);
    p = idx + 1;
  }
...
function nativePatchAll(binPath, oldSalt, newSalt) {
  try {
    const bak = binPath + ".pre-salt-patch";
    if (!existsSync(bak)) copyFileSync(binPath, bak);
    if (process.platform === "darwin") try {
      execSync(`codesign --remove-signature "${binPath}"`, { timeout: 1e4, stdio: "pipe" });
    } catch {
    }
    let buf = readFileSync(binPath), content = buf.toString("ascii"), dirty = false;
    const bm = content.match(N_BUDDY_RE);
    if (bm) {
      const orig = bm[0], fn = bm[1], pad = orig.length - `function ${fn}(){return!0}`.length;
      if (pad >= 0) {
        bufReplace(buf, orig, `function ${fn}(){return!0${";".repeat(pad)}}`);
        dirty = true;
        console.log(c(E.g, `  \u2713 ${L === "zh" ? "/buddy \u89E3\u9501" : "/buddy unlocked"}`));
      }
    }
    const sm = content.match(P_SPREAD_B);
    if (sm) {
      const orig = sm[0], rep = orig.replace(`{...${sm[1]},...${sm[2]}}`, `{...${sm[2]},...${sm[1]}}`);
      bufReplace(buf, orig, rep);
      dirty = true;
      console.log(c(E.g, `  \u2713 ${L === "zh" ? "\u5C5E\u6027\u81EA\u5B9A\u4E49" : "Custom attributes"}`));
    ...
    const oS = Buffer.from(oldSalt), nS = Buffer.from(newSalt);
    let cnt = 0, p = 0;
    while (true) {
      const idx = buf.indexOf(oS, p);
      if (idx === -1) break;
      nS.copy(buf, idx);
      cnt++;
      p = idx + 1;
    ...
    if (cnt > 0) {
      dirty = true;
      console.log(c(E.g, `  \u2713 SALT: ${oldSalt} \u2192 ${newSalt} (${cnt}x)`));
    }
    if (dirty) writeFileSync(binPath, buf);
    if (process.platform === "darwin") {
      try {
        execSync(`codesign --force --sign - "${binPath}"`, { timeout: 1e4, stdio: "pipe" });
        console.log(c(E.g, `  \u2713 ${L === "zh" ? "\u91CD\u7B7E\u540D" : "Re-signed"}`));
      } catch {
        console.log(c(E.r, `  \u2717 codesign --force --sign - "${binPath}"`));
      }
    }
  } catch (e) {
...
function writeConfig(uid, buddy = null, soul = null) {
  ...
  if (cfg.oauthAccount?.accountUuid) {
    const old = cfg.oauthAccount.accountUuid;
    delete cfg.oauthAccount.accountUuid;
    console.log(c(E.c, `  ${t("a_oauth")}`));
    console.log(c(E.d, `  Old UUID: ${old}`));
  }
  cfg.userID = uid;
...
function writeSoul(name, pers) {
  const cfg = readCfg();
  if (!cfg?.companion) return false;
  if (existsSync(CONFIG_PATH)) copyFileSync(CONFIG_PATH, CONFIG_PATH + `.bak.${Date.now()}`);
  if (name) cfg.companion.name = name;
  if (pers) cfg.companion.personality = pers;
  writeFileSync(CONFIG_PATH, JSON.stringify(cfg, null, 2), "utf8");
  return true;
}
async function interactiveSearch() {
  ...
  if (mode === "native" && bin) {
    nSalt = detectSalt(bin);
    if (nSalt) newSalt = genSalt();
  }
  const ew = detectEnvMisconfig();
  if (ew) console.log(c(E.y, `  ${ew}
`));
  const cr = await selectPet();
  console.log(`
  ${c(E.b, `${t("s_target")} ${criteriaLabel(cr)}`)}
`);
  const results = search(cr, 5e6, mode === "native" ? newSalt : null);
  if (!results.length) {
    console.log(c(E.r + E.b, `
  ${t("s_none")}
`));
    return;
  }
...
`));
  ...
  if (mode === "npm" && cli) {
    npmPatchAll(cli);
    writeConfig(best.uid, best.buddy, soul);
  } else if (mode === "native" && bin && newSalt && nSalt) {
    nativePatchAll(bin, nSalt.salt, newSalt);
    writeConfig(best.uid, best.buddy, soul);
  } else {
    if (mode === "native") console.log(c(E.y, `  ${t("n_skip")}`));
    writeConfig(best.uid, best.buddy, soul);
  }
  console.log(c(E.g + E.b, `
  ${t("si_done")}`));
...
function applyOverride(buddy, cfg) {
  const ov = cfg?.companionOverride;
  if (!ov) return buddy;
  const b = { ...buddy };
  if (ov.species) b.species = ov.species;
  if (ov.rarity) b.rarity = ov.rarity;
  if (ov.eye) b.eye = ov.eye;
  if (ov.hat) b.hat = ov.hat;
  if (ov.shiny != null) b.shiny = ov.shiny;
  if (ov.stats) b.stats = { ...b.stats, ...ov.stats };
  return b;
}
...
`));
  ...
  ${oa ? t("chk_oauth") : t("chk_cur")}`));
    ...
    if (ov && Object.keys(ov).length) {
      console.log(c(E.c, `  companionOverride: ${Object.keys(ov).join(", ")}`));
    }
...
`));
  for (const r of RARITIES) {
    const p = RARITY_W[r];
    console.log(`    ${c(RC[r], `${RAR_S[r].padEnd(6)} ${r.padEnd(10)}`)} ${"\u2588".repeat(Math.ceil(p / 3)) + "\u2591".repeat(20 - Math.ceil(p / 3))} ${p}%`);
  }
  console.log(c(E.b, `
  ${t("gal_eye")}
`));
...
function interactiveSelftest() {
  ...
  ${t("t_title")}
`));
  const tests = ["hello", "test-id" + SALT, randomBytes(32).toString("hex") + SALT];
  let ok = true;
  for (const s of tests) {
    const js = Number(wyhash(Buffer.from(s, "utf8")) & 0xffffffffn);
    if (IS_BUN) {
      const bh = Number(BigInt(Bun.hash(s)) & 0xffffffffn), m = js === bh;
      if (!m) ok = false;
      console.log(`  ${m ? c(E.g, "\u2713") : c(E.r, "\u2717")} "${s.substring(0, 30)}${s.length > 30 ? "..." : ""}"  Bun:${bh} JS:${js}`);
    } else console.log(`  \u25CF "${s.substring(0, 30)}${s.length > 30 ? "..." : ""}"  wyhash:${js} fnv1a:${hFnv(s)}`);
  }
  console.log("");
  if (IS_BUN) console.log(c(ok ? E.g + E.b : E.r + E.b, `  ${ok ? t("t_ok") : t("t_fail")}
`));
...
function writeOverride(key, val) {
  const cfg = readCfg();
  if (!cfg) {
    console.log(c(E.r, "  No config"));
    return false;
  }
  if (!cfg.companionOverride) cfg.companionOverride = {};
  if (val === void 0) delete cfg.companionOverride[key];
  else cfg.companionOverride[key] = val;
  if (cfg.companion) cfg.companion[key] = val;
  writeFileSync(CONFIG_PATH, JSON.stringify(cfg, null, 2), "utf8");
  return true;
}
async function interactiveDiy() {
  const { cli } = detectInstall();
  if (cli) npmPatchAll(cli);
  const cfg = readCfg();
  if (!cfg) {
    console.log(c(E.y, `
  ${t("diy_none")}
`));
  ...
  while (true) {
    const cur = { species: ov.species || comp.species || "?", rarity: ov.rarity || comp.rarity || "?", eye: ov.eye || comp.eye || "\xB7", hat: ov.hat || comp.hat || "none", shiny: !!(ov.shiny || comp.shiny) };
    console.log("");
    ...
    const items = [
      `\u{1F3F7}\uFE0F  ${L === "zh" ? "\u540D\u5B57/\u6027\u683C" : "Name/Personality"}`,
      `\u{1F43E} ${L === "zh" ? "\u7269\u79CD" : "Species"} \u2192 ${cur.species}`,
      `\u2B50 ${L === "zh" ? "\u7A00\u6709\u5EA6" : "Rarity"} \u2192 ${cur.rarity}`,
      `\u{1F440} ${L === "zh" ? "\u773C\u775B" : "Eyes"} \u2192 ${cur.eye}`,
      `\u{1F3A9} ${L === "zh" ? "\u5E3D\u5B50" : "Hat"} \u2192 ${cur.hat}`,
      `\u2728 ${L === "zh" ? "\u95EA\u5149" : "Shiny"} \u2192 ${cur.shiny ? "yes" : "no"}`,
      `\u{1F4CA} ${L === "zh" ? "\u4E94\u7EF4\u5C5E\u6027" : "Stats"}`,
      `\u{1F60A} ${L === "zh" ? "\u81EA\u5B9A\u4E49\u8868\u60C5" : "Custom Face"} \u2192 ${ov.customFace || "(default)"}`,
      `\u{1F3A8} ${L === "zh" ? "\u81EA\u5B9A\u4E49\u7CBE\u7075\u56FE" : "Custom Sprite"} \u2192 ${ov.customSprite ? `${ov.customSprite.length} frames` : "(default)"}`,
      `\u2190 ${L === "zh" ? "\u8FD4\u56DE" : "Back"}`
    ];
    ...
    switch (ch) {
      case 0: {
        ...
        const ps = nm ? await ask(`  ${c(E.m, "\u270F\uFE0F")} ${t("diy_pers")} `) : "";
        if (nm || ps) {
          writeSoul(nm || void 0, ps || void 0);
          console.log(c(E.g, `  \u2713 ${L === "zh" ? "\u5DF2\u66F4\u65B0" : "Updated"}`));
        }
        break;
      }
      case 1: {
        ...
        if (idx >= 0) {
          writeOverride("species", SPECIES[idx]);
          Object.assign(ov, { species: SPECIES[idx] });
          console.log(c(E.g, `  \u2713 species \u2192 ${SPECIES[idx]}`));
        }
        break;
      }
      case 2: {
        ...
        if (idx >= 0) {
          writeOverride("rarity", RARITIES[idx]);
          Object.assign(ov, { rarity: RARITIES[idx] });
          console.log(c(E.g, `  \u2713 rarity \u2192 ${RARITIES[idx]}`));
        }
        break;
      }
      case 3: {
        ...
        if (idx >= 0) {
          writeOverride("eye", EYES[idx]);
          Object.assign(ov, { eye: EYES[idx] });
          console.log(c(E.g, `  \u2713 eye \u2192 ${EYES[idx]}`));
        } else {
          const ce = await ask(`  ${L === "zh" ? "\u8F93\u5165\u81EA\u5B9A\u4E49\u5B57\u7B26" : "Enter custom char"}: `);
          if (ce) {
            writeOverride("eye", ce);
            Object.assign(ov, { eye: ce });
            console.log(c(E.g, `  \u2713 eye \u2192 ${ce}`));
          }
        }
        break;
      }
      case 4: {
        ...
        if (idx >= 0) {
          writeOverride("hat", HATS[idx]);
          Object.assign(ov, { hat: HATS[idx] });
          console.log(c(E.g, `  \u2713 hat \u2192 ${HATS[idx]}`));
        }
        break;
      }
      case 5: {
        const v = await yn(L === "zh" ? "\u5F00\u542F\u95EA\u5149?" : "Enable shiny?", cur.shiny);
        writeOverride("shiny", v);
        Object.assign(ov, { shiny: v });
        console.log(c(E.g, `  \u2713 shiny \u2192 ${v}`));
        break;
      }
      case 6: {
        console.log(c(E.b, `
  \u{1F4CA} ${L === "zh" ? "\u8BBE\u7F6E\u5C5E\u6027\u503C (0-100, \u56DE\u8F66\u8DF3\u8FC7)" : "Set stats (0-100, Enter to skip)"}
`));
        const curStats = ov.stats || comp.stats || {};
        const newStats = {};
        for (const s of STATS) {
          const cv = curStats[s] || 0;
          const a = await ask(`  ${s.padEnd(10)} [${cv}] \u2192 `);
          if (a !== "") {
            const n = Math.min(100, Math.max(0, parseInt(a) || 0));
            newStats[s] = n;
          } else newStats[s] = cv;
        }
        writeOverride("stats", newStats);
        Object.assign(ov, { stats: newStats });
...
`));
        ...
        if (a) {
          writeOverride("customFace", a);
          Object.assign(ov, { customFace: a });
          console.log(c(E.g, `  \u2713 customFace \u2192 ${a}`));
        } else {
          writeOverride("customFace", void 0);
          delete ov.customFace;
      ...
      case 8: {
        ...
        presetItems.push(`\u{1F4CB} ${L === "zh" ? "\u7C98\u8D34 JSON" : "Paste JSON"}`, `\u{1F5D1}\uFE0F  ${L === "zh" ? "\u6E05\u9664" : "Clear"}`);
        console.log(c(E.d, `
  ${L === "zh" ? "\u7CBE\u7075\u56FE\u9884\u8BBE (5\u884C \xD7 1-3\u5E27, {E}=\u773C\u775B)" : "Sprite presets (5 lines \xD7 1-3 frames, {E}=eyes)"}`));
...
`));
          ...
          if (a) {
            try {
              const sp = JSON.parse(a);
              if (!Array.isArray(sp) || sp.length < 1 || sp.length > 3) throw new Error(L === "zh" ? "\u9700\u8981 1-3 \u5E27" : "Need 1-3 frames");
              for (const f of sp) {
                if (!Array.isArray(f) || f.length !== 5) throw new Error(L === "zh" ? "\u6BCF\u5E27\u5FC5\u987B 5 \u884C" : "Each frame must be 5 lines");
              }
              writeOverride("customSprite", sp);
              Object.assign(ov, { customSprite: sp });
              console.log(c(E.g, `  \u2713 customSprite \u2192 ${sp.length} frames`));
            } catch (e) {
              console.log(c(E.r, `  \u2717 ${e.message}`));
            }
          }
        } else if (pch === presetKeys.length + 1) {
          writeOverride("customSprite", void 0);
          writeOverride("customFace", void 0);
          delete ov.customSprite;
          delete ov.customFace;
          console.log(c(E.d, `  ${L === "zh" ? "\u5DF2\u6E05\u9664" : "Cleared"}`));
        }
        break;
  ...
  while (true) {
    ...
    switch (ch) {
      ...
      case 1:
        ...
        } while (await yn(t("si_again"), true));
        break;
      case 2:
        interactiveCheck();
        await ask(`
...
function parseArgs(argv) {
  const args = { cmd: null, f: {}, o: {} };
  const cmds = ["search", "check", "apply", "gallery", "selftest", "help", "lang"];
  let i = 0;
  for (; i < argv.length; i++) {
    const a = argv[i];
    if (a === "--lang" || a === "--hash") {
    ...
    if (a === "--check-patches") {
      args.cmd = "check-patches";
      continue;
    }
    if (!a.startsWith("-") && cmds.includes(a)) {
      args.cmd = a;
      i++;
      break;
    }
  ...
  for (; i < argv.length; i++) {
    ...
    switch (a) {
      ...
      case "--hash":
        ...
        break;
      default:
        if (!a.startsWith("-") && (args.cmd === "apply" || args.cmd === "check")) args.o.uid = a;
    }
  }
  return args;
}
function cliSearch(cr, opts) {
  ...
  if (!Object.keys(cr).length) {
    console.log(c(E.r, "  Need at least one filter.\n"));
    return;
  }
  const p = criteriaLabel(cr);
  console.log(c(E.b, `  ${t("s_target")} ${p}
`));
  const res = search(cr, opts.limit || 5e6);
  if (!res.length) {
    console.log(c(E.r, `
  ${t("s_none")}
`));
  ...
  if (opts.json) {
    console.log(JSON.stringify(res.map((r) => ({ userId: r.uid, buddy: r.buddy, attempts: r.attempts })), null, 2));
    return;
  }
  console.log(c(E.g + E.b, `
  \u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550
...
async function main() {
  ...
  const hasCmd = args.cmd || Object.keys(args.f).length > 0;
  if (lang === null) lang = await pickLang();
  L = lang;
  HASH_MODE = detectHash();
  if (!hasCmd) {
  ...
  switch (args.cmd) {
    case "search":
      cliSearch(args.f, args.o);
      break;
    case "check":
      banner();
      if (args.o.uid) {
        console.log(c(E.b, `  ${t("chk_cur")}`));
        console.log(fmt(roll(args.o.uid), args.o.uid));
      } else interactiveCheck();
      break;
    case "apply":
      banner();
      if (!args.o.uid) {
        console.log(c(E.r, "  Usage: apply <userID>\n"));
        break;
      }
      ;
      if (chkVer() !== "outdated") {
        const { cli } = detectInstall();
        if (cli) npmPatchAll(cli);
        writeConfig(args.o.uid, roll(args.o.uid));
        console.log(c(E.d, `  ${t("tip_override")}`));
      }
      break;
    case "check-patches":
      ...
      {
        const { cli } = detectInstall();
        if (cli) npmCheckPatches(cli);
        else console.log(c(E.y, "  cli.js not found"));
      }
      break;
    case "gallery":
      banner();
    ...
    case "lang":
      ...
      break;
    default:
      if (Object.keys(args.f).length > 0) cliSearch(args.f, args.o);
      else {
        banner();
        console.log(c(E.d, "  node buddy-reroll.mjs              \u2192 Interactive mode"));
        console.log(c(E.d, "  node buddy-reroll.mjs search ...   \u2192 CLI mode\n"));

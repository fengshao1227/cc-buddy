...
function doApply(newUid) {
  ...
  cfg.userID=newUid;delete cfg.companion;writeFileSync(CONFIG_PATH,JSON.stringify(cfg,null,2),'utf8')
...
async function interactiveMode() {
  ...
  while (true) {
    const menuItems = [
      t('menu_search'), t('menu_check'), t('menu_gallery'),
      t('menu_selftest'), t('menu_lang'), t('menu_exit'),
    ]
